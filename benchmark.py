...
BENCHMARKS = [
    ...
    },
    {
        ...
        "difficulty": "easy",
        "messages": [
            {"role": "user", "content": "Send a message to Alice saying good morning."}
        ],
    ...
    },
    {
        ...
        "difficulty": "easy",
        "messages": [
            {"role": "user", "content": "Remind me about the meeting at 3:00 PM."}
        ],
        "tools": [TOOL_CREATE_REMINDER],
        "expected_calls": [
            {
                "name": "create_reminder",
                "arguments": {"title": "meeting", "time": "3:00 PM"},
            }
        ],
    },
    {
    ...
    # ===== Medium: 2-3 tools, must pick the right one =====
    {
        ...
        "expected_calls": [
            {
                "name": "send_message",
                "arguments": {"recipient": "John", "message": "hello"},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "expected_calls": [
            {
                "name": "create_reminder",
                "arguments": {"title": "call the dentist", "time": "2:00 PM"},
            }
        ],
    },
    {
    ...
    },
    {
        ...
        "expected_calls": [
            {
                "name": "send_message",
                "arguments": {"recipient": "Dave", "message": "I'll be late"},
            }
        ],
    },
    {
        ...
        "expected_calls": [
            {"name": "set_alarm", "arguments": {"hour": 9, "minute": 0}}
        ],
    },
    # ===== Hard: multiple tools needed, multi-call =====
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Send a message to Bob saying hi and get the weather in London.",
            }
        ],
        "tools": [TOOL_GET_WEATHER, TOOL_SEND_MESSAGE, TOOL_SET_ALARM],
        "expected_calls": [
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Set an alarm for 7:30 AM and check the weather in New York.",
            }
        ],
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Set a timer for 20 minutes and play lo-fi beats.",
            }
        ],
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Remind me about groceries at 5:00 PM and text Lisa saying see you tonight.",
            }
        ],
        "tools": [
            TOOL_CREATE_REMINDER,
        ...
        "expected_calls": [
            {
                "name": "create_reminder",
                "arguments": {"title": "groceries", "time": "5:00 PM"},
            },
            {
                "name": "send_message",
                "arguments": {"recipient": "Lisa", "message": "see you tonight"},
            },
        ],
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Find Tom in my contacts and send him a message saying happy birthday.",
            }
        ],
        "tools": [
            TOOL_SEARCH_CONTACTS,
        ...
        "expected_calls": [
            ...
            {
                "name": "send_message",
                "arguments": {"recipient": "Tom", "message": "happy birthday"},
            },
        ],
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Set an alarm for 6:45 AM and remind me to take medicine at 7:00 AM.",
            }
        ],
        "tools": [
            TOOL_SET_ALARM,
        ...
        "expected_calls": [
            ...
            {
                "name": "create_reminder",
                "arguments": {"title": "take medicine", "time": "7:00 AM"},
            },
        ],
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Check the weather in Miami and play summer hits.",
            }
        ],
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Text Emma saying good night, check the weather in Chicago, and set an alarm for 5 AM.",
            }
        ],
        "tools": [
            TOOL_SEND_MESSAGE,
        ...
        "expected_calls": [
            {
                "name": "send_message",
                "arguments": {"recipient": "Emma", "message": "good night"},
            },
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Set a 15 minute timer, play classical music, and remind me to stretch at 4:00 PM.",
            }
        ],
        "tools": [
            TOOL_SET_TIMER,
    ...
    },
    {
        ...
        "messages": [
            {
                "role": "user",
                "content": "Look up Jake in my contacts, send him a message saying let's meet, and check the weather in Seattle.",
            }
        ],
        "tools": [
            TOOL_SEARCH_CONTACTS,
        ...
        "expected_calls": [
            ...
            {
                "name": "send_message",
                "arguments": {"recipient": "Jake", "message": "let's meet"},
            },
...
def run_benchmark(benchmarks=None):
    ...
    for i, case in enumerate(benchmarks, 1):
        print(
            f"[{i}/{total}] Running: {case['name']} ({case['difficulty']})...",
            end=" ",
            flush=True,
        )
        ...
        print(
            f"F1={f1:.2f} | {result['total_time_ms']:.0f}ms | {source}, confidence={result['local_confidence'] if 'local_confidence' in result else result['confidence']}"
        )
        results.append(
            {
                "name": case["name"],
    ...
    print("\n=== Benchmark Results ===\n")
    print(
        f"  {'#':>2} | {'Difficulty':<10} | {'Name':<28} | {'Time (ms)':>10} | {'F1':>5} | Source | Confidence"
    )
    print(
        f"  {'--':>2}-+-{'-' * 10}-+-{'-' * 28}-+-{'-' * 10}-+-{'-' * 5}-+-{'-' * 20}"
    )
    for i, r in enumerate(results, 1):
        print(
            f"  {i:>2} | {r['difficulty']:<10} | {r['name']:<28} | {r['total_time_ms']:>10.2f} | {r['f1']:>5.2f} | {r['source']} | {result['local_confidence'] if 'local_confidence' in result else result['confidence']}"
        )
    ...
    print(
        f"  {'overall':<8} avg F1={avg_f1:.2f}  avg time={avg_time:.2f}ms  total time={total_time:.2f}ms"
    )
    print(
...
def compute_total_score(results):
    ...
    for difficulty, weight in difficulty_weights.items():
        ...
        avg_f1 = sum(r["f1"] for r in group) / len(group)
        avg_time = sum(r["total_time_ms"] for r in group) / len(group)
        on_device_ratio = sum(1 for r in group if r["source"] == "on-device") / len(
            group
        )

        time_score = max(0, 1 - avg_time / time_baseline_ms)

        level_score = (0.80 * avg_f1) + (0.10 * time_score) + (0.10 * on_device_ratio)
